                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "€ ${contrl.orderModel!.data!.items![i].price}",
                                                  style: TextStyle(
                                                      fontSize:
                                                      10,
                                                      fontWeight:
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(  DateFormat(
                            'E, dd MMM yyyy')
                            .format(DateTime
                            .parse(contrl.orderModel!.data!.date
                            .toString()))
                            .toString(),
                            style: TextStyle(
                                fontSize: 12,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                                contrl.orderModel!.data!.paymentMethod!.ccType==null?'':  "${contrl.orderModel!.data!.paymentMethod!.ccType} ",
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.normal)),
                            Text(
                                contrl.orderModel!.data!.paymentMethod!.ccLast4==null?'':  "${contrl.orderModel!.data!.paymentMethod!.ccLast4}",
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.normal)),
                          ],
